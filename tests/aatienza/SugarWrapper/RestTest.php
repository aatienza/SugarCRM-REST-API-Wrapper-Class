...
use aatienza\SugarWrapper\Rest;
 ...
 * @license MIT License
 * @link    http://github.com/aatienza/SugarCRM-REST-API-Wrapper-Class/
 */
class RestTest extends \PHPUnit_Framework_TestCase
{
    /**
     *
     * @var \aatienza\SugarWrapper\Rest
     */
    protected $api;

    /**
     *
     * @var \aatienza\Curl|\Mockery\MockInterface
     */
    protected $curl;
    ...
    public function setUp()
    {
        ...
        $this->curl = \Mockery::mock('\aatienza\Curl');
    }
    ...
    public function testGetCurlReturnsNewCurl()
    {
        ...
        $this->assertInstanceOf('\aatienza\Curl', $actual);
